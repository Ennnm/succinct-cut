        ...
        {ready && user !== null ? (
          <>
            <h2 className={styles.title}>
              <strong>Make your videos succinct!</strong>
            </h2>

            <p className={styles.description}>
              Remove disfluencies | Shorten long pauses | Keeping you smooth
            </p>
            <div className={styles.grid}>
              <div className={styles.card} onClick={onBrowseBtnClick}>
                {video && (
                  <video
              ...
              <div className={styles.card} onClick={onDownloadClick}>
                {video &&
