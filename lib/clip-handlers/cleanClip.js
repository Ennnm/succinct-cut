...
export const cleanClip = async (
  ...
  try {
    ...
    setProcessStage('Preparing to stitch');
    ...
    setProcessStage('Stitching video');
    console.time('concat');
    ...
    setProcessStage('Clearing memory');
